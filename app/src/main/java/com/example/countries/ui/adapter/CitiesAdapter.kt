...
class CitiesAdapter( var mContext : Context,
                     var citiesList : List<Cities>,
                     var viewModel : CitiesViewModel): RecyclerView.Adapter<CitiesAdapter.CitiesCardHolder>() {

    inner class CitiesCardHolder(binding: CardviewDesignCitiesBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesCardHolder {
        ...
        val binding:CardviewDesignCitiesBinding = DataBindingUtil.inflate(layoutInflater,
